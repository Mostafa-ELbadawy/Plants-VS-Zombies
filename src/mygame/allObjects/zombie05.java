 ...
 * @author Nada youssef
 */
public class zombie05 extends Zombie {

//private final AnimEventListener listener;`
    public zombie05(AssetManager asset) {

        super(asset);
        Node node = (Node) assetManager.loadModel("Blender/zombie05/zombie.j3o");
        name = "Jill_HiRes_Teeth_Geo";
        this.node = node;
        this.node.setName("zombie");
        System.out.println("5555555");
       node.setLocalScale(6.5f, 6.5f, 6.5f);
